 ...
 */
class CoroutinesPrinterTextParserColumn(
    textParserLine: CoroutinesPrinterTextParserLine,
    oldTextColumn: String
) {
    val line: CoroutinesPrinterTextParserLine
    var elements = arrayOfNulls<CoroutinesIPrinterTextParserElement>(0)
        private set
    ...
    private fun appendString(text: String): CoroutinesPrinterTextParserColumn {
    ...
    private fun prependElement(element: CoroutinesIPrinterTextParserElement): CoroutinesPrinterTextParserColumn {
        val elementsTmp = arrayOfNulls<CoroutinesIPrinterTextParserElement>(elements.size + 1)
    ...
    private fun appendElement(element: CoroutinesIPrinterTextParserElement): CoroutinesPrinterTextParserColumn {
        val elementsTmp = arrayOfNulls<CoroutinesIPrinterTextParserElement>(elements.size + 1)
